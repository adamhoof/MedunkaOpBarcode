#### The main goal of this project is to speed up goods unpacking in store by not having to put physical price tags on them and check stock with computer every time.
